<section class="py-16 md:py-24 bg-gradient-to-r from-purple-600 to-pink-700 text-white">
    <div class="container mx-auto px-4 text-center"><svg xmlns="http://www.w3.org/2000/svg" width="64"
        ...
        <h2 class="text-3xl md:text-4xl font-bold mb-6"><?php _e('library.cta.title'); ?></h2>
        <p class="text-lg text-purple-100 max-w-2xl mx-auto mb-8"><?php _e('library.cta.description'); ?></p>
        <div class="flex flex-row justify-center gap-4 items-center sm:space-y-0 sm:space-x-6 px-4">
            <a href="#themes">
                <button
                    ...
                    </svg><?php _e('library.cta.button_themes'); ?>
                </button></a>
            ...
            <a href="#plugins">
                <button
                    ...
                    </svg><?php _e('library.cta.button_plugins'); ?>
                </button></a>
        </div>
