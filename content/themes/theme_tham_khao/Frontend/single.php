<?php
/**
 * Template: Single Post (generic)
 * Head + Schema: mặc định từ context (global $post). Override: Head::setTitle() / filter render.head.defaults.
 */
...
view_header(['layout' => $layout ?? 'single']);
?>
