...
Render::block('Backend\Header', ['layout' => 'default', 'title' => __('Bulk Edit Posts'), 'breadcrumb' => $breadcrumbs]);
...
<?php Render::asset('js', 'js/spreadsheet-helper.js', ['area' => 'backend', 'location' => 'head']); ?>
