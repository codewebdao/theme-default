...
<div class="hidden lg:flex items-center ">
  ...
  <nav class="flex items-center space-x-2 xl:space-x-2 lg:space-x-0">
    <?php foreach ($menu_items as $item):
      ...
      $link_class = $link_class_base . ($is_active ? 'bg-home-surface-light text-home-primary' : 'text-gray-700 hover:text-home-primary dark:text-gray-300 dark:hover:bg-home-surface-light dark:hover:text-home-primary');
    ?>
  ...
  <div class="relative lang-dropdown-js">
    <button type="button" aria-haspopup="true" aria-expanded="false" aria-controls="lang-menu-pc"
      class="lang-dropdown-btn flex items-center gap-2 px-2 h-[36px] bg-gray-100 rounded-home-md hover:bg-gray-200 transition font-semibold dark:border dark:border-zinc-600 dark:bg-zinc-800 dark:hover:bg-zinc-700">
