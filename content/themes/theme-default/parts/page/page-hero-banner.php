...
?>
<section class="relative w-full overflow-hidden bg-white dark:bg-gray-950" id="page-cms-banner"
    aria-labelledby="page-cms-banner-title">
    <!-- Nền: cùng tông xanh nhạt dưới ảnh để không lộ mép trắng / xám lệch -->
    <div class="pointer-events-none absolute inset-0 z-0 bg-[#eef3fb] dark:bg-zinc-900" aria-hidden="true"></div>
    <div class="absolute inset-0 z-0 overflow-hidden">
        <img src="<?php echo e(theme_assets('images/banner_cms.webp')); ?>" alt=""
            class="h-full min-h-full w-full object-cover object-center dark:brightness-[0.42] dark:contrast-[1.05]" />
        ...
        <!-- Một lớp: dọc (xuống trắng / tối) + nhẹ ngang (mềm mé), tránh band ngang -->
        <div class="pointer-events-none absolute inset-0 z-[2] dark:hidden"
        ...
        <div class="pointer-events-none absolute inset-0 z-[2] hidden bg-gradient-to-b from-transparent via-gray-950/75 to-gray-950 dark:block"
            aria-hidden="true"></div>
    </div>
    ...
    <div class="relative z-10 container mx-auto flex min-h-[400px] flex-col px-4 pb-16 pt-6 sm:min-h-[460px] sm:px-6 sm:pb-20 sm:pt-8 md:min-h-[500px] md:pb-24">
        <div
            ...
            <h1 id="page-cms-banner-title"
                class="sr sr--fade-up mb-4 w-full font-space text-[34px] font-bold leading-tight text-black sm:text-4xl md:text-[56px] md:leading-[1.1] dark:text-gray-50" style="--sr-delay: 0ms">
                <?php echo e($pageHeroTitle); ?>
            </h1>
            <?php if ($pageHeroSubtitle !== '') { ?>
                <p class="sr sr--fade-up mx-auto max-w-xl font-plus text-sm leading-relaxed text-gray-600 sm:text-base md:text-lg dark:text-gray-300" style="--sr-delay: 60ms">
