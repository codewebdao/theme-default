...
<div class="mb-12 sm:px-0">
    <h1 class="text-3xl md:text-[30px] lg:text-[48px] xl:text-[64px] 
           font-bold text-black 
           text-center lg:text-left
           mb-3 sm:mb-6 
           leading-tight  font-space">
    ...
    <!-- Cards Grid -->
    <div
        class="flex md:grid md:grid-cols-3 gap-4 md:gap-6 mb-12 overflow-x-auto md:overflow-x-visible md:pb-0 scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0">
        <!-- Quick Start Card -->
        <div @click="activeTab = 'installation'"
            class="group rounded-home-lg transition-all duration-300 border border-transparent md:border-gray-200 p-[1px] bg-gradient-to-r from-home-accent to-home-primary md:bg-none md:p-0 md:hover:border-transparent md:hover:p-[1px] md:hover:bg-gradient-to-r md:hover:from-home-accent md:hover:to-home-primary flex-shrink-0 w-[200px] md:w-full cursor-pointer">
            <div
                class="group relative w-full h-full bg-white rounded-home-lg p-4 md:p-6 lg:p-3 xl:p-6 hover:shadow-lg transition-all duration-200 overflow-hidden">
