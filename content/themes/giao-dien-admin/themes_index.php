...
View::addJs('page-jsf-jszip-min-js', 'js/jszip.min.js', [], null, true, false, true, false);
view_header([
    'title' => __('themes management'),
    'layout' => 'default',
    'user_info' => $user_info ?? [],
    'menuData' => $menuData ?? [],
...
<?php
View::addJs('page-jsf-jszip-min-js', 'js/jszip.min.js', [], null, true, false, true, false);
// View::addJs('page-jsf-themes-js', 'js/themes.js', [], null, true, false, true, false);
view_footer();
?>
