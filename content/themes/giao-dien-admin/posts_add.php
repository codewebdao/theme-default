...
if ($loadtinymce) {
    View::addJs('page-js-tinymce-min-js', 'tinymce/tinymce.min.js', [], null, false, false, false, false);
}

// [1] LẤY CÁC THÔNG TIN CHUNG
view_header([
    'title' => $isEdit ? __('Edit') : __('Add'),
    'layout' => 'default',
    'user_info' => $user_info ?? [],
    'menuData' => $menuData ?? [],
...
<div class="pc-container">
    <div class="pc-content relative">
        ...
        <form id="acf-form" method="post" action="" enctype="multipart/form-data">
            ...
            <script type="module" crossorigin src="<?= theme_assets('js/posts_add.js') ?>"></script>
            <link rel="stylesheet" crossorigin href="<?= theme_assets('css/posts_add.css') ?>">
