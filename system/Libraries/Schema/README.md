...
- **Schema.php** – Entry: `Schema::render()` / `Schema::get()`; `setCurrentContext()` / `getCurrentContext()` (context từ layout)
...
```php
\System\Libraries\Schema\Schema::render();  // echo
$html = \System\Libraries\Schema\Schema::get();  // return string
```
