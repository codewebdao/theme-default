...
- Schema Library đặt tại `system/Libraries/Render/Schema/`
...
- **Schema.php** (entry point) nằm cùng cấp với Head.php, View.php: `system/Libraries/Render/Schema.php` (không nằm trong thư mục Schema/).

```
system/Libraries/Render/
├── Schema.php          // Entry point (public API), setCurrentContext/getCurrentContext – file: ../Schema.php
├── ...
system/Libraries/Render/Schema/
